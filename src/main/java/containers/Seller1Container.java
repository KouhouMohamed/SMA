...
public class Seller1Container extends Application{
	...
	private void startContainer() throws Exception {
		...
		AgentController consumerController1 = container.createNewAgent("seller_1", "agents.Seller1Agent",new Object[] {this});
		//AgentController consumerController2 = container.acceptNewAgent("seller_2", new Seller2Agent(),new Object[] {this} );
